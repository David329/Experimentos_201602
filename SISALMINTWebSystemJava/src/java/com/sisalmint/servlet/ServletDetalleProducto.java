...
import com.sisalmint.servicios.ServicioTipo;
...
public class ServletDetalleProducto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ServicioTipo st=new ServicioTipo();
        ...
        request.setAttribute("LstTipo",st.getTipos());
        request.getRequestDispatcher("Producto/DetalleProducto.jsp").forward(request, response);
    }
