                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left" action="ServletAddEditProduct?editar=<%=objproduct == null ? "0" : "1"%>" novalidate method="post">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input value="<%=objproduct == null ? "" : objproduct.getFallaFabrica()%>" <%=objproduct == null ? "" : "readonly"%> id="falla" name="falla" type="radio" value="0" checked="true"> No          <input id="cantidad" name="cantidad" type="radio" value="Sí"> Sí
                                </div>
                            </div>			
